                    ...
                    <div class="search_bm_request">
                        <div class="row">
                                ...
                                <div class="search_bm_request text-center">
                                    <div class="row d-flex flex-row justify-content-center">
                                        <div class="ctrl_title title mb-2 col-md-3">
                                            <div class="form-focus"> <input value="" id="txt_title" type="text"
                                                    class=" rounded form-control form-control-sm floating "><label
                                                    class="focus-label">Nhan đề </label></div>
                                        </div>
                                        <div class="ctrl_author author mb-2 col-md-3">
                                            <div class="form-focus"> <input value="" id="txt_author" type="text"
                                                    class="  rounded form-control form-control-sm floating "><label
                                                    class="focus-label">Danh mục </label></div>
                                        </div>
                            ...
                            <div class="ol-xl-2 col-lg-2 col-md-2">
                                ...
                                <button id="btn-filter" class="mx-1 mb-2 btn btn-primary btn-sm"> <i
                                        class="fa-solid fa-magnifying-glass "></i> </button>
                                <button id="btn-refresh"
                                    class="mx-1 mb-2 bg-secondary text-white btn btn-outline-secondary2 btn-sm"> <i
                                ...
                                <tr>
                                    ...
                                    <td style="" class="text-center">
                                        ...
                                        <a class="edit-flower btn btn-secondary btn-sm text-white" href="#"
                                            data-bs-toggle="modal" data-bs-target="#modalEditFlower" data-id="6"
                                            data-name="Hoa Dạ "
                                            data-description="Dạ yến thảo là lựa chọn thích hợp cho những ai yêu thích trồng hoa làm đẹp nhà ở. Hoa có thể nở rực quanh năm, kể cả tiết trời se lạnh của mùa xuân hay cả những ngày nắng nóng cao điểm của mùa hè. Dạ yến thảo được trồng ở chậu treo nơi cửa sổ hay ban công, dáng hoa mềm mại, sắc màu đa dạng nên được yêu thích vô cùng."
                                            data-images="../images/hoa-da-yen-thao.webp,../images/hoa-da-yen-thao-1.webp">
                                            Sửa
                                        </a>
                                        <!-- Xóa -->
